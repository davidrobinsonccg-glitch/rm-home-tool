...
const SPOCK_LOOKUP={
  ...
  "red.frozen.all_day":{primaryTool:"No-Demand Presence",primarySteps:["A day-long freeze is the nervous system in deep shutdown — it has been overwhelmed and is conserving.","Do not attempt to activate, reason, or reassure.","Stay in the space, doing something quiet of your own. This can last a long time.","Offer food and water without making it a demand: 'I've left something here.'","Dim the environment if you can. Reduce noise and inputs.","Check in with yourself — staying regulated through this requires effort. Take your own breaks."],secondaryTool:"Gentle Sensory",secondaryNote:"Warmth and texture, offered and left nearby. Temperature changes can be particularly effective at gentle activation.",sayThis:["'I'm here. Nothing needs to happen today.'"],spockNote:"A day of freeze is the nervous system communicating that it has been carrying more than it could. The most therapeutic thing available to you right now is consistent, non-demanding presence."},
  ...
  "yellow.argumentative.overwhelmed":{primaryTool:"Movement Break",primarySteps:["When overwhelm is underneath the argument, the demand is too high right now — don't push it.","'Let's take a break before we come back to this.' No negotiation needed.","Offer movement: 'Want to move around for a bit first?'","Keep the break genuine — 5-10 minutes, no pressure about what comes after.","When you return: reduce the demand. Break it into one smaller piece."],secondaryTool:"Micro-Choice",secondaryNote:"On return, offer a micro-choice about how to start: 'Do you want to begin with the easy bit or just pick a place?'",sayThis:["'Let's take a break before we come back to this.'","'Want to move around for a bit?'"],spockNote:"Argumentation driven by overwhelm is the nervous system saying the demand exceeds current capacity. Reducing the demand is not giving in — it is reading the situation accurately."},
  ...
  "yellow.refusal.task":{primaryTool:"Micro-Choice",primarySteps:["The refusal is about the task — make the task feel less like a wall.","Identify what's non-negotiable (the task outcome) and what's genuinely flexible (how, when, where).","'You can do this sitting or standing — your call.' Or: 'Do you want to start at the beginning or pick a part?'","After they choose: 'Good.' Move on without commentary.","Don't revisit the choice or check whether they're doing it 'right'."],secondaryTool:"Movement Break",secondaryNote:"If the task has been looming for a while, a short movement break before returning to it can lower the activation threshold.",sayThis:["'You can do this here or somewhere else — up to you.'","'Want to try the easy bit first?'"],spockNote:"Task refusal is often about the experience of being controlled, not about the task itself. Genuine choice within the task restores the sense of agency that makes engagement possible."},
  ...
  // ── GREEN ─────────────────────────────────────────────────────────────────
  "green.connection.conversation":{primaryTool:"2×10 Strategy",primarySteps:["This is the window — use it for genuine conversation, not administration.","Start with something you genuinely know they care about: ask about it with real curiosity.","Listen more than you speak. Follow their thread — don't redirect to what you want to cover.","No agenda beyond knowing them better in this moment.","2 minutes of this, done consistently, builds the relational account that everything else draws from."],secondaryTool:"Affect Labelling",secondaryNote:"If something emotional comes up: name it warmly, then follow their lead.",sayThis:["'I've been thinking about [their interest] — tell me more about it.'","'What's the best part of [thing they care about]?'"],spockNote:"The green zone is the only time the investment in relationship is fully available. Don't waste it on tasks or correction — this is when the account gets built."},
  ...
  "green.pattern.mood":{primaryTool:"Zones Check-in",primarySteps:["If mood is driving the pattern, make mood visible and nameable.","Build a daily zones check-in into the routine — morning and after school at minimum.","Keep it brief and consistent: 'How's your body feeling right now?' Accept any answer warmly.","Over time, the check-in becomes a shared language and an early-warning system.","Use the data: if they're consistently yellow on Mondays, Monday needs a lighter load."],secondaryTool:"Affect Labelling",secondaryNote:"Mood-pattern days benefit from affect labelling during them: 'You seem a bit [feeling] today.' Then nothing — just acknowledgement.",sayThis:["'How's your body feeling right now?'"],spockNote:"Mood patterns are nervous system patterns — they respond to data and structure, not reasoning. Building check-ins into the routine creates the data you need to respond proactively."},

  "green.proactive.transition":{primaryTool:"Predictability Anchor",primarySteps:["Name the transition coming: what it is, when it is, what it leads to.","Give advance notice: 'In [days/hours], [change] is going to happen. Here's what it will look like.'","Acknowledge the difficulty without overdramatising it: 'Changes like this can feel unsettled — that's okay.'","Offer a choice within the transition where possible.","Build a known routine anchor for the day of the transition."],secondaryTool:"Zones Check-in",secondaryNote:"Check in more frequently in the lead-up: 'How's your body feeling about [transition]?' No fixing — just noticing.",sayThis:["'I want to give you a heads-up about something coming.'","'Here's what it will look like: [simple sequence].'"],spockNote:"Advance notice is not just courtesy — it is neurological preparation. A nervous system that can predict a change has more regulatory capacity available during it."},
  "green.proactive.difficult_day":{primaryTool:"Predictability Anchor",primarySteps:["Map out the day together or just for yourself: what's likely to be hard, when, in what order.","Build movement opportunities and check-ins into the day before the hard moments arrive.","Lower all discretionary demands on a day that's already heavy.","Have a regulation strategy agreed in advance: 'If things get big, we can [x].'","Keep the day as predictable as possible — don't add surprises."],secondaryTool:"Movement Break",secondaryNote:"Build movement into the start of a difficult day — it raises the regulatory threshold before demands arrive.",sayThis:["'I know today might be a big one. Let's go slowly.'","'If things get hard, we can [agreed strategy].'"],spockNote:"Preparing for a difficult day is not pessimism — it is the most effective regulatory move available. A pre-loaded plan costs less than a reactive repair."},
  ...
  "blue.withdrawn.off":{primaryTool:"Rhythmic Low-Demand",primarySteps:["Switched-off needs gentle activation — not questions, not demands.","Offer a low-cognitive-load rhythmic activity: 'I've got [thing] here if you want it.' Put it near them and step back.","Options: folding, sorting, colouring, bouncing a ball, a simple repetitive game.","Don't explain why. Don't check if it's working.","Sit nearby doing something of your own. Parallel engagement is fine."],secondaryTool:"Gentle Sensory",secondaryNote:"A warm drink placed nearby. Or something with texture. Temperature input is particularly effective for hypoarousal.",sayThis:["'I've got [activity] here if you want it.'","'No pressure at all.'"],spockNote:"A switched-off state is hypoarousal — the nervous system has downshifted. It needs bottom-up activation through rhythm and sensation, not top-down input through language."},
  ...
  "blue.slow.woke_like_it":{primaryTool:"Rhythmic Low-Demand",primarySteps:["Waking slow is often the nervous system's baseline on high-load days — work with it, not against it.","Don't add demands at the start — build into the morning routine slowly.","Offer a rhythmic activity with breakfast or before anything else: quiet music, something to fold, a simple game.","Morning check-in can be very brief: one word, one emoji, even a thumbs up. Just acknowledgement.","Build in movement before any cognitive demand."],secondaryTool:"Gentle Sensory",secondaryNote:"Warmth at the start — warm drink, warm shower — physically shifts the arousal state.",sayThis:["'Morning. No rush.'","'I've got [warm thing] here.'"],spockNote:"A slow start is not a predictor of the whole day — but demanding pace before the nervous system is ready can make it one. Meet the pace, then gently lift it."},
  ...
  "blue.reluctant.demands":{primaryTool:"No-Demand Presence",primarySteps:["Anything framed as a demand will be refused right now — remove the demand framing entirely.","Move alongside them without any task in mind.","Do something of your own in their space.","After 10+ minutes of no demands: offer something optional. 'I'm going to do [x] — you're welcome to join if you feel like it.' No pressure.","Let them choose to engage — don't draw them in."],secondaryTool:"Rhythmic Low-Demand",secondaryNote:"Offer a rhythmic activity as a non-demand: 'I've got [thing] here.' Put it near them. Step back.",sayThis:["'Nothing needs to happen right now.'","'I'm just going to be here for a bit.'"],spockNote:"When demands are the barrier, removing the demand framing is the first move. Connection before direction — and only when the connection is established."},
  "blue.reluctant.social":{primaryTool:"Side-by-Side",primarySteps:["Social demand is too high right now — parallel engagement is the available option.","Move into the same space without requiring interaction.","Do something of your own. No eye contact unless offered. No conversation unless initiated.","Let the shared space do its work — proximity without demand.","Over time, if they engage: follow their lead, don't increase the social demand."],secondaryTool:"Interest Hook",secondaryNote:"If you know an interest domain: mention it casually without requiring engagement. 'I was thinking about [interest] earlier.' Then say nothing more.",sayThis:["'I'm just going to be in here.'","(Then quiet — let them lead)"],spockNote:"Social reluctance in the blue zone is the nervous system signalling that face-to-face engagement is currently too costly. Side-by-side presence makes connection available without requiring it."},
  ...
  "yellow.restless.transition":{primaryTool:"Transition Warning",primarySteps:["Name what just happened: 'I know we just changed gears — that can feel unsettled.'","Give a clear, brief picture of what comes next: 'We're going to [x], then [y] after that.'","Use the same words each time you give transition warnings — predictability of the warning matters as much as the warning itself.","Offer a micro-choice within the new activity: 'Do you want to start with [a] or [b]?'","Don't rush the settling — give it 2-3 minutes without new demands."],secondaryTool:"Movement Snack",secondaryNote:"A 2-minute movement snack during the transition helps the nervous system shift gears. 'Before we start the next thing, let's do 20 jumps.'",sayThis:["'I know we just changed — that can feel unsettled.'","'Here's what's coming: [simple sequence].'"],spockNote:"Transition restlessness is not defiance — it is a nervous system mid-shift. The transition warning and a movement snack give it something to do with that energy rather than leaving it to manifest as dysregulation."},

  "yellow.refusal.transition":{primaryTool:"Transition Warning",primarySteps:["Don't increase pressure — it will deepen the refusal.","Name what's happening: 'I know it's hard to switch gears.'","Give a clear, calm picture: 'After this we're going to [x], and then [y].'","Give a time anchor: 'In about 3 minutes we're going to move. I'll give you a heads-up.'","Offer a small choice within the transition: 'Do you want to walk or take the long way?'"],secondaryTool:"Movement Snack",secondaryNote:"Build movement into the transition itself — it helps the nervous system shift state and makes the transition feel less abrupt.",sayThis:["'I know it's hard to switch gears.'","'In 3 minutes we're going to move — I'll let you know.'"],spockNote:"Transition refusal is one of the most consistent presentations of a nervous system that struggles with unpredictability. The warning and a movement bridge are not accommodations — they are the efficient path through."},

  // Environmental/sensory paths
  "yellow.restless.noisy":{primaryTool:"Environmental Priming",primarySteps:["The environment is contributing before any behaviour management is attempted.","Immediately reduce the primary sensory load: lower background noise, reduce visual clutter if possible.","Move to a quieter space if available — don't negotiate, just invite: 'Come with me for a minute.'","Once in a calmer environment: offer movement before returning to any demand.","Note what the environment was doing — this is information for future priming."],secondaryTool:"Movement Snack",secondaryNote:"After reducing environmental load, a brief movement snack consolidates the shift before returning to demands.",sayThis:["'Let's move somewhere quieter for a bit.'","'Want to come with me?'"],spockNote:"A noisy environment is doing regulatory work on the nervous system whether anyone notices it or not. Addressing the environment is always the first move — addressing the behaviour without addressing the environment is working against physics."},

  // Body-doubling for blue initiation paths
  "blue.reluctant.everything":{primaryTool:"Body-Doubling",primarySteps:["Initiation is the barrier — not motivation, not capacity. The executive function cost of starting anything is currently too high.","Move into the same space and begin doing something of your own. No commentary.","Your regulated, focused presence lowers their initiation threshold — this is body-doubling.","After 5-10 minutes of parallel presence: offer one tiny optional entry point. 'I'm going to [x] — you're welcome to join if you feel like it.'","Don't set expectations about output. Initiation is the entire goal."],secondaryTool:"Micro-Choice",secondaryNote:"Once they've initiated anything — even glancing at a task — offer a micro-choice: 'Do you want to start with [a] or [b]?' This transfers control without withdrawing structure.",sayThis:["'I'm just going to be in here working on something.'","'No pressure — I'm just here.'"],spockNote:"Universal reluctance is an initiation problem driven by executive function load. Body-doubling works because a regulated person in the same space provides external activation that compensates for the internal deficit. The evidence base for this in ADHD presentations is growing, with strong practitioner consensus and consistent self-report data."},

  "blue.slow.woke_like_it":{primaryTool:"Environmental Priming",primarySteps:["A slow start means the nervous system needs a gentle ramp — not demands.","Prepare the morning environment before anyone arrives in it: warm, quiet, food accessible, no decisions required.","Warm drink available without asking. Clothes laid out. Nothing to find, nothing to decide.","Build a brief movement snack into the first 10 minutes before any cognitive demand.","The morning check-in can be one word or a gesture — don't require language before regulation."],secondaryTool:"Movement Snack",secondaryNote:"Even 2 minutes of gentle movement — a slow walk, some stretching — before any cognitive demand raises the regulatory baseline.",sayThis:["'Morning. No rush.'","'I've got [warm drink] here.'"],spockNote:"A slow start is the nervous system communicating its baseline. The most efficient response is a primed environment that requires no decisions — not encouragement, not urgency. Meet the pace; then gently raise it."},

  // Interest-led entry for blue/green connection paths
  "green.connection.activity":{primaryTool:"Interest-Led Entry",primarySteps:["Choose an activity connected to something they currently care about — not what you think they should care about, what they actually do.","Invite without pressure: 'I'm going to [interest-related thing] — do you want to join?' Then start.","Don't direct or teach during the activity. Follow their lead entirely.","Let conversation happen naturally — don't force it.","This is not productive time. It is relational time. The connection is the output."],secondaryTool:"Side-by-Side",secondaryNote:"If they're not ready for joint activity, side-by-side presence in the same space still builds connection through proximity.",sayThis:["'I'm going to [interest-related thing] — you're welcome to join.'","'What are you into at the moment?'"],spockNote:"Interest-led entry is not a technique — it is evidence that you know who this person is. The regulatory effect of being genuinely known is supported across therapeutic alliance research and self-determination theory — both point to it clearly. This is the 2×10 strategy operationalised through activity."},

  // Narrated calm for red escalation that resists all other approaches
  "red.explosive.peaked":{primaryTool:"Narrated Calm",primarySteps:["The peak means the worst is likely passing — don't restart it with demands or problem-solving.","Speak quietly, to yourself rather than to them: 'I'm just going to breathe for a minute.'","Do it audibly — a slow inhale and long exhale. Your breath is the signal.","'I'm feeling pretty calm right now. I'm just going to stay here.'","Don't narrate their state. Only yours. 'I'm okay' — not 'you're okay.'","When they settle: 'Good. Just breathe.' Then nothing. Repair comes much later."],secondaryTool:"No-Demand Presence",secondaryNote:"Once narrated calm has begun to land, shift to pure no-demand presence — present, quiet, making nothing required.",sayThis:["'I'm just going to breathe for a minute.' (then do it audibly)","'I'm here. I'm calm. No rush.'"],spockNote:"A peaked escalation is already resolving. The narrated calm gives the nervous system a regulated frequency to entrain to — which is precisely what Polyvagal Theory predicts. Your audible breath is not symbolic. It is a biological input."},

  // Co-regulation through activity for yellow/blue social refusal
  "yellow.refusal.social":{primaryTool:"Co-regulation Through Activity",primarySteps:["Don't force proximity to the other person — the refusal is a safety signal.","Introduce a shared activity that both people can do without direct interaction: building, drawing, a game with low social demand.","Invite without pressure: 'I'm going to [activity] — you're welcome to join.'","Let them participate at whatever level they choose. Don't narrate or direct.","Over time, the shared activity creates the conditions for connection — but connection is not the requirement, it's the possible outcome."],secondaryTool:"Side-by-Side",secondaryNote:"If shared activity is too much, side-by-side presence in the same space still lowers the social demand while maintaining proximity.",sayThis:["'I'm going to [activity] — you're welcome to join.'","'You can stay right here.'"],spockNote:"Social refusal at the yellow edge is the nervous system assessing a situation as requiring more social capacity than is currently available. Shared activity reduces the social processing cost while maintaining the opportunity for connection. This is co-regulation through the side door."},

  // Repair ritual for green proactive work
  "green.proactive.recurring":{primaryTool:"Repair Ritual",primarySteps:["Something recurring needs both a collaborative conversation and a structural response.","In a genuinely calm moment: 'I've noticed [pattern] keeps coming up. I'd like to understand it better.'","'What's it like for you when [x] happens?' — listen first, fix nothing.","Together, agree on a brief repair ritual for when this pattern occurs: a phrase, a gesture, something that signals reset.","Make one small structural change based on what you heard. The ritual handles the relational; the structural change handles the trigger."],secondaryTool:"Predictability Anchor",secondaryNote:"Build a predictability anchor around the recurring situation — advance warning where possible, consistent structure around it.",sayThis:["'I've noticed [pattern] keeps coming up. Can we talk about it?'","'What would help when that happens?'"],spockNote:"A recurring difficulty is an unsolved problem. In the green zone, collaborative problem-solving is available — including designing a repair ritual together. A ritual the child helped design has the strongest chance of being used when the pattern recurs."},

  // Sensory diet for blue withdrawal after something
  "blue.slow.after_something":{primaryTool:"Sensory Diet Check",primarySteps:["Something happened and they're still carrying it — before anything else, check the sensory picture.","Has there been enough proprioceptive input today? Heavy work, movement, physical activity?","Has there been too much aversive sensory input — noise, crowds, transitions, unexpected touch?","If proprioception is low: offer heavy work. 'Can you help me carry this?' or 'Let's do some wall push-ups.'","If overload is the issue: reduce everything. Quieter space, fewer people, preferred texture or warmth available.","Once the sensory picture is addressed, connection becomes available — don't try to access it first."],secondaryTool:"No-Demand Presence",secondaryNote:"Stay present while the sensory needs are being met. Don't add the demand of conversation on top of the recovery.",sayThis:["'I'm here if you want to say anything.'","'Take all the time you need.'"],spockNote:"Slowness after something happened is the nervous system processing. Before accessing the event cognitively, check whether the sensory foundation is in place. A nervous system in sensory deficit cannot do emotional processing efficiently."},
};
...
function SpockScreen({profiles,onClose,onUpdateProfile,t}){
  ...
  const followup=selectedZone?SPOCK_FOLLOWUPS[selectedZone]:null;
      ...
      {step==="question"&&q&&(
        <>
          ...
          <div style={{display:"flex",gap:10}}>
            ...
            <LCARSBtn label="Skip this one" colour={t.textMuted} small onClick={skipQuestion} style={{background:"transparent",border:`1px solid ${t.border}`}}/>
          </div>
...
function ProfileView({member,onClose,onSave,t}){
      ...
      <div style={{background:t.surface,borderRadius:16,maxWidth:640,width:"100%",border:`2px solid ${c}66`,alignSelf:"flex-start"}}>
        ...
        <div style={{display:"flex",padding:"12px 16px 0",borderBottom:`1px solid ${t.border}`,overflowX:"auto",gap:0}}>
          ...
          <button onClick={()=>setShowMoreTabs(m=>!m)}
            style={{background:secondaryTabs.includes(tab)?c:showMoreTabs?c+"44":"transparent",color:secondaryTabs.includes(tab)?"#000":t.textMuted,border:"none",borderRadius:"8px 8px 0 0",padding:"8px 12px",fontFamily:"'Antonio',sans-serif",fontWeight:700,fontSize:11,letterSpacing:"0.06em",textTransform:"uppercase",cursor:"pointer",whiteSpace:"nowrap",transition:"all 0.12s",minHeight:44}}>
            {secondaryTabs.includes(tab)?tab.toUpperCase():"MORE ▾"}
          </button>
        </div>
...
const ZONE_EXPLAINERS={
  red:{
    ...
    important:"This is often mistaken for 'yellow' because the person might not seem as distressed as you'd expect. If reasoning isn't working, they are red.",
  ...
  yellow:{
    ...
    important:"Yellow is the intervention window. Red has already happened. Yellow is where the tools work.",
  ...
  green:{
    ...
    important:"Green is the time to invest — in relationship, in teaching strategies, in repair. It is not just the absence of a problem.",
  ...
  blue:{
    ...
    important:"Blue is not a choice. It is the nervous system in dorsal vagal shutdown — a protective state. Demands and consequences make it worse.",
      ...
      <div style={{background:t.surface,border:`2px solid ${z.colour}`,borderRadius:16,maxWidth:480,width:"100%",overflow:"hidden",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        <div style={{padding:18}}>
          {[
            ...
            {label:"What to do right now",text:z.doNow},
          ].map(({label,text,bold})=>(
...
function QuickStartGuide({onClose,t}){
  ...
  const sections=[
    ...
    {title:"The four zones",content:[
      ...
      {h:"🟡 Yellow — approaching the edge",p:"Elevated, but still reachable. This is where the tools work. Movement, genuine choice, transition warnings. Act early — don't wait for red."},
      ...
      {h:"🔵 Blue — shutdown",p:"Under-activated. Not lazy, not rude — the nervous system has gone into protective shutdown. Warmth, rhythm, no demands. Gentle sensory input. Wait."},
    ]},
  ...
  return(
    <div style={{background:t.surface,border:`1px solid ${colour}44`,borderRadius:12,overflow:"hidden"}}>
      ...
      <div style={{padding:"12px 14px"}}>
        <div style={{fontFamily:"'Antonio',sans-serif",fontSize:20,fontWeight:700,color:colour,letterSpacing:"0.08em",marginBottom:2}}>{member.code}</div>
        {z?(
          <div style={{marginBottom:8}}>
...
function RoutineBlock({routine,completions,today,children,onToggle,t}){
  const rc={morning:P.amber,afterschool:P.teal,bedtime:P.lilac}[routine.id]||P.spock;
  return(
    <div style={{marginBottom:20}}>
      ...
      {(routine.steps||[]).map(step=>(
        <RoutineStepRow key={step.id} step={step} completions={completions} today={today} children={children} routineColour={rc} onToggle={onToggle} t={t}/>
      ))}
    </div>
  );
}
  ...
  return(
    <div>
      ...
      <div style={{fontFamily:"'Nunito',sans-serif",fontSize:13,color:t.textMuted,lineHeight:1.6,marginBottom:16}}>
        Tap a child's initial beside each step to mark it complete. Tap again to undo.
      </div>
...
const INTENTION_LIBRARY=[
  ...
  "I will do one thing today that is just for me — however small.",
        ...
        {!lowCapacity&&(
          <div style={{marginBottom:10,padding:"10px 14px",background:t.surface,border:`1.5px solid ${intention?.checked?P.teal:P.teal+"44"}`,borderRadius:12,transition:"border-color 0.2s"}}>
            ...
            {intention&&!editingIntention?(
              ...
              {/* Suggestion buttons — overwrite draft immediately */}
...
function buildDefaultRoutines(profiles){
  ...
  return{
    morning:{id:"morning",label:"Morning",emoji:"☀️",repeat:"daily",startTime:"07:00",notes:"",steps:[
      mk("☀️","Everyone wakes up","family",5,"",P.amber),
      mk("💧","Water before anything else","family",2,"Regulation starts with hydration.",P.paleBlue),
      mk("💬","Morning check-in — how's your body?","family",5,"Zones check-in. No pressure. Just notice.",P.spock),
      mk("🍳","Breakfast together","family",20,"",P.amber),
      mk("🦷","Teeth & wash","family",10,"",P.teal),
      mk("👕","Get dressed","family",10,"Lay clothes out the night before if transitions are hard.",P.teal),
      mk("🎒","Pack bag / check list","family",5,"Visual checklist helps — don't rely on memory.",P.amber),
      mk("⏰","5-minute warning before leaving","family",5,"Transition warning. Not 'hurry up' — 'we leave in 5.'",P.dustyRed),
      mk("🚗","Leave","family",0,"",P.dustyRed),
    ]},
    afterschool:{id:"afterschool",label:"After School",emoji:"🏠",repeat:"weekdays",startTime:"15:30",notes:"",steps:[
      mk("🏠","Arrive home","family",0,"",P.teal),
      mk("🌀","Decompress — no demands","family",20,"Nervous system needs to downshift after school. No questions, no homework yet.",P.spock),
      mk("🍎","Snack","family",10,"A snack after school helps stabilise blood sugar, which has a direct effect on mood and regulation capacity.",P.amber),
      mk("🌳","Outside / movement","family",20,"Movement before any cognitive demands. Not optional for ADHD presentations.",P.teal),
      mk("💬","Check-in — how was it?","family",10,"Green zone only. Side-by-side works better than face-to-face.",P.spock),
      mk("📖","Reading / quiet time","family",20,"",P.lilac),
      mk("🍳","Help with dinner prep","family",15,"Side-by-side activity builds connection without demands.",P.amber),
    ]},
    bedtime:{id:"bedtime",label:"Bedtime",emoji:"🌙",repeat:"daily",startTime:"19:30",notes:"",steps:[
      mk("⏰","30-minute wind-down warning","family",2,"Predictability anchor. Same time, same words, every night.",P.dustyRed),
      mk("📱","Screens off","family",2,"Blue light affects melatonin. Worth protecting this boundary.",P.dustyRed),
      mk("🛁","Bath / shower","family",15,"Warm bath lowers core temperature post-bath — genuinely regulatory.",P.paleBlue),
      mk("🦷","Teeth & wash","family",5,"",P.teal),
      mk("🌙","Pyjamas","family",5,"",P.lilac),
      mk("📚","Story / reading time","family",15,"The 2×10 strategy in practice — one of the most consistent relational investments in the daily routine.",P.spock),
      mk("💬","One good thing from today","family",5,"Not forced positivity — genuine noticing. Can be tiny. If nothing felt good today, naming what was hard counts too.",P.spock),
      mk("😴","Lights out","family",0,"Same time every night where possible — consistent timing supports the body's sleep-wake rhythm.",P.lilac),
    ]},
  };
}
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"#000000CC",zIndex:910,overflowY:"auto",padding:16,display:"flex",justifyContent:"center"}}>
      <div style={{background:t.surface,borderRadius:16,maxWidth:680,width:"100%",border:`2px solid ${ac}66`,alignSelf:"flex-start"}}>
        ...
        {/* Edit subtabs — only shown when Edit tab is active */}
        {tab==="edit"&&(
          <div style={{display:"flex",padding:"8px 16px 0",borderBottom:`1px solid ${t.border}`,gap:0,background:t.surface2}}>
            {EDIT_SUBTABS.map(st=>(
              <button key={st.id} onClick={()=>setEditRoutine(st.id)}
                style={{background:editRoutine===st.id?st.colour+"33":"transparent",color:editRoutine===st.id?st.colour:t.textMuted,border:"none",borderBottom:editRoutine===st.id?`2px solid ${st.colour}`:"2px solid transparent",padding:"6px 14px",fontFamily:"'Antonio',sans-serif",fontWeight:700,fontSize:11,letterSpacing:"0.08em",textTransform:"uppercase",cursor:"pointer",whiteSpace:"nowrap",transition:"all 0.12s",display:"flex",alignItems:"center",gap:4}}>
                <span style={{fontSize:13}}>{st.emoji}</span>{st.label}
              </button>
            ))}
          </div>
        )}
...
const STRATEGY_LIBRARY=[
  {id:1,name:"Space & Silence",zone:["red"],type:"De-escalation",emoji:"🤫",
   when:"Student is above the window. Physical escalation possible. Reasoning is clearly inaccessible.",
  ...
  {id:12,name:"The 2×10 Strategy",zone:["green"],type:"Relationship",emoji:"❤️",
   ...
   why:"Wlodkowski's observational research reported an 85% improvement in the target student's behaviour — a striking finding, though not from a randomised controlled trial. The relational mechanism is strongly supported across multiple implementation studies.",
  ...
  return(
    <div style={{fontFamily:"'Nunito',sans-serif"}}>
      ...
      {openProfile&&profiles[openProfile]&&(
        <ProfileView member={profiles[openProfile]} onClose={()=>setOpenProfile(null)} onSave={handleSaveProfile} t={t}/>
      )}
      {showRoutines&&(
